 ...
 * @generated
 */
public class ArboreoSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ArboreoPackage.NAMED_ELEMENT: {
